...
- (void)addPrecise:(UInt32)label
            vector:(Float64 const *_Nonnull)vector NS_SWIFT_NAME(addPrecise(label:vector:));

- (UInt32)searchPrecise:(Float64 const *_Nonnull)vector
                  count:(UInt32)count
                 labels:(UInt32 *_Nullable)labels
              distances:(Float32 *_Nullable)distances NS_SWIFT_NAME(searchPrecise(vector:count:labels:distances:));

- (void)addImprecise:(UInt32)label
              vector:(void const *_Nonnull)vector NS_SWIFT_NAME(addImprecise(label:vector:));

- (UInt32)searchImprecise:(void const *_Nonnull)vector
                    count:(UInt32)count
                   labels:(UInt32 *_Nullable)labels
                distances:(Float32 *_Nullable)distances NS_SWIFT_NAME(searchImprecise(vector:count:labels:distances:));
