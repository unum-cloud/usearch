...
extern "C"
{
  ...
  typedef struct {
    bool is_err;
    union {
      usearch_wasm_index_t ok;
      usearch_wasm_error_t err;
    } val;
  } usearch_wasm_expected_index_error_t;
  void usearch_wasm_expected_index_error_free(usearch_wasm_expected_index_error_t *ptr);
  typedef struct {
    bool is_err;
    union {
      usearch_wasm_size_t ok;
      usearch_wasm_error_t err;
    } val;
  } usearch_wasm_expected_size_error_t;
  ...
  } usearch_wasm_expected_bool_error_t;
  void usearch_wasm_expected_bool_error_free(usearch_wasm_expected_bool_error_t *ptr);
  void usearch_wasm_init(usearch_wasm_init_options_t *options, usearch_wasm_expected_index_error_t *ret0);
  void usearch_wasm_release(usearch_wasm_index_t index, usearch_wasm_error_t *ret0);
  void usearch_wasm_save(usearch_wasm_index_t index, usearch_wasm_string_t *path, usearch_wasm_error_t *ret0);
  void usearch_wasm_load(usearch_wasm_index_t index, usearch_wasm_string_t *path, usearch_wasm_error_t *ret0);
  void usearch_wasm_view(usearch_wasm_index_t index, usearch_wasm_string_t *path, usearch_wasm_error_t *ret0);
  void usearch_wasm_size(usearch_wasm_index_t index, usearch_wasm_expected_size_error_t *ret0);
  void usearch_wasm_capacity(usearch_wasm_index_t index, usearch_wasm_expected_size_error_t *ret0);
  void usearch_wasm_dimensions(usearch_wasm_index_t index, usearch_wasm_expected_size_error_t *ret0);
  void usearch_wasm_connectivity(usearch_wasm_index_t index, usearch_wasm_expected_size_error_t *ret0);
  void usearch_wasm_reserve(usearch_wasm_index_t index, usearch_wasm_size_t capacity, usearch_wasm_error_t *ret0);
  void usearch_wasm_add(usearch_wasm_index_t index, usearch_wasm_key_t key, usearch_wasm_vector_t *array, usearch_wasm_scalar_kind_t vector_kind, usearch_wasm_error_t *ret0);
  void usearch_wasm_contains(usearch_wasm_index_t index, usearch_wasm_key_t key, usearch_wasm_expected_bool_error_t *ret0);
  void usearch_wasm_search(usearch_wasm_index_t index, usearch_wasm_vector_t *array, usearch_wasm_scalar_kind_t kind, usearch_wasm_size_t results_limit, usearch_wasm_keys_t *found_labels, usearch_wasm_distances_t *found_distances, usearch_wasm_expected_size_error_t *ret0);
  void usearch_wasm_get(usearch_wasm_index_t index, usearch_wasm_key_t key, usearch_wasm_vector_t *array, usearch_wasm_scalar_kind_t vector_kind, usearch_wasm_expected_bool_error_t *ret0);
  void usearch_wasm_remove(usearch_wasm_index_t index, usearch_wasm_key_t key, usearch_wasm_expected_bool_error_t *ret0);
  #ifdef __cplusplus
}
#endif
#endif
